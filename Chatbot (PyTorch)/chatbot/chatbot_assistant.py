...
class ChatbotAssistant:
    ...
    def train_model(self, batch_size, lr, epochs):
        ...
        self.model = chatbot_model.ChatbotModel(self.X.shape[1], len(self.intents))
    ...
    def load_model(self, model_path, dimensions_path):
        ...
        self.model = chatbot_model.ChatbotModel(dimensions["input_size"], dimensions["output_size"])
